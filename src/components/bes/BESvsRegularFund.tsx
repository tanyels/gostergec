  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="border border-slate-200 rounded-lg p-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between">
              <span className="text-slate-600">Yönetim Ücreti</span>
      ...
      <div className="bg-slate-100 rounded-lg p-4">
        <h4 className="font-semibold text-slate-800 mb-2">Karşılaştırma Sonucu</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div>
            <p className="text-slate-600">Ücret Farkı:</p>
            <p className="font-semibold text-red-600">
              BES fonu yılda %{feeDifference.toFixed(1)} daha fazla ücret alıyor
            </p>
          </div>
          <div>
            <p className="text-slate-600">Getiri Farkı (USD):</p>
